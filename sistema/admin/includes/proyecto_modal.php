        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="project_edit.php">
                <input type="hidden" class="proj" name="id">
                  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="date" class="form-control" id="edit_start" name="f_start">
                      </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="date" class="form-control" id="edit_finish" name="f_finish">
                      </div>
                    </div>
                </div>
            </div>
